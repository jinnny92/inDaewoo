...
public class UserDTO implements Serializable{
	...
	public UserDTO(String userId, String uName, String uNickname, String uPassword, String uBirth, int uPostnumber,
			String uAddress, String udetailAddress, String uPhone, String uEmail, String uGrade, int uSigndate,
			String uPoint) {
		super();
		this.userId = userId;
		this.uName = uName;
	...
	public int getuSigndate() {
		return uSigndate;
	}

	public void setuSigndate(int uSigndate) {
		this.uSigndate = uSigndate;
	}
